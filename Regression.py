...
# 2. Uploads the file to an Azure blob - you"d need an Azure storage account
...
def saveBlobToFile(blobUrl, resultsLabel):
    output_file = "MLSHoursResults.csv" # Replace this with the location you would like to use for your output file, and valid file extension (usually .csv for scoring results, or .ilearner for trained models)
...
def invokeBatchExecutionService():
    ...
    storage_account_key = "-------"
    storage_container_name = "sm-ticketdata"
    ...
    payload = {
            ...
            "Outputs": {
                    ...
                    {
                        "ConnectionString": connection_string,
                        "RelativeLocation": "/" + storage_container_name + "/MLSHoursOutput.csv" # Replace this with the location you would like to use for your output file, and valid file extension (usually .csv for scoring results, or .ilearner for trained models)
                    },
            },
